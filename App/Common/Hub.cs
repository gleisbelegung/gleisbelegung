...
namespace Gleisbelegung.App.Common
{
    public class Hub
    {
        ...
        public void Subscribe(Type type, Action<object> handler)
        {
            Subscribe(type, this, handler);
        }

        public void Subscribe<T>(object subscriber, Action<T> handler)
        {
            SubscribeDelegate(typeof(T), subscriber, handler);
        }

        public void Subscribe(Type type, object subscriber, Action<object> handler)
        {
            SubscribeDelegate(type, subscriber, handler);
        }
        ...
        private void SubscribeDelegate(Type type, object subscriber, Delegate handler)
        {
